...
function Appearance({ title, description, event, cta, href }) {
  return (
    <Card as="article">
      <Card.Title as="h3">
        {href ? (
          <Card.Link href={href} rel="nofollow noopener noreferrer" target="_blank">
            {title}
          </Card.Link>
        ) : (
          title
...
export const metadata = {
  title: 'Speaking - Victoria Jordan',
  description: "If you are looking for your next guest speaker, I'm your girl!",
};